...
{
    // This part reuses the code in Math.Net, which is built on package amos å
    // References:
    // [1] https://github.com/scipy/scipy/blob/master/scipy/special/amos_wrappers.c
    // [2] https://github.com/mathnet/mathnet-numerics/tree/master/src/Numerics/SpecialFunctions/Amos
    public static partial class SF
    {
        static class Amos
        {
            #region additional part for gamma
